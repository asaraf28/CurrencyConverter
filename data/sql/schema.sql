...
CREATE TABLE currency_rate (from_code VARCHAR(3), to_code VARCHAR(3), rate DOUBLE(20, 18) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(from_code, to_code)) ENGINE = INNODB;
